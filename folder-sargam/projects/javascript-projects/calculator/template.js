export default options => (`
            ...
            <div class="calculator__body">
                ...
                <button class="calculator__body-key" data-action="pop"><img src="./assets/backspace.svg" alt="<-"></button>
                ...
                <button class="calculator__body-key calculator__delete-once" data-prefix="point">.</button>
